...
public class Fbo {
	...
	public void resloveToFBO(int targetBuffer, Fbo fbo){
		...
		GL30.glBlitFramebuffer(0, 0, width, height, 0, 0, fbo.width, fbo.height,
	...
	private void initialiseFrameBuffer(int type) {
		...
		if(multiSampleAndMultiTarget){
			...
			colourBuffer3 = createMultiSampleColourAttachment(GL30.GL_COLOR_ATTACHMENT2);
		}else{
